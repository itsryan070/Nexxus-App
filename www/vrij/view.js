        ...
        var popup = "";
                ...
                + "<div class='ui-popup-container pop in ui-popup-activ' id='reden-popup' style='max-width: 330px; top: 171px; left: 29px;'>"
                    ...
                    + "<form>"
                        ...
                        +"</label>"
                    +"</form>"
                    + "<div onclick='c.closingPopup()' class='ui-green mc-text-center'><a data-rel='back' class='ui-btn ui-corner-all ui-shadow ui-btn-b mc-top-margin-1-5' data-disabled='false'>Bevestig</a></div>"
                 + "</div>"
            +"</div>"
        + "</div>"
        $("#footer").after(popup);
